...
--
-- Host: localhost:3306
-- Generation Time: Dec 27, 2023 at 02:57 PM
...
(1, 3, 'Device Test Blog', '@devices', '<p>Answers to all your questions about the Kindle Unlimited reading subscription</p>', '#android,#ios,#laptop', '#android,#ios,#laptop', 'publish', 'Unknown', '2023-11-22 09:44:54', '2023-12-18 05:52:00'),
...
(2, 'School Registration Form', 'School Registration Form', '@RegistrationForm', '/student-register', 'save_entry', '<div class=\"card\"><div class=\"card-body\"><style>.displayGeneratedForm .card{background-color: grey;}</style><h2 class=\"text-center\">School Registration Form</h2><p class=\"text-muted\"></p><p>This is test student registration form which preview in frontend side as its preview seen in below if you haven\'t seen the preview please click \"Preview Form\" Button below for form preview</p><p></p><form action=\"/student-register\" method=\"post\" enctype=\"multipart/form-data\" id=\"dynamicForm\"><label>Name</label><input type=\"text\" class=\"form-control rounded-1\" name=\"name\" placeholder=\"Enter input Name name\" required=\"\"><label>Hobby</label><div classname=\"form-check\"><input classname=\"form-check-input\" type=\"checkbox\" name=\"hobby\" value=\"cricket\" id=\"Playing Cricket_\"><label classname=\"form-check-label\" for=\"Playing Cricket_\">Playing Cricket</label></div><div classname=\"form-check\"><input classname=\"form-check-input\" type=\"checkbox\" name=\"hobby\" value=\"music\" id=\"Listening Music_\"><label classname=\"form-check-label\" for=\"Listening Music_\">Listening Music</label></div><div classname=\"form-check\"><input classname=\"form-check-input\" type=\"checkbox\" name=\"hobby\" value=\"coding\" id=\"Coding_\"><label classname=\"form-check-label\" for=\"Coding_\">Coding</label></div><label>Gender</label><div class=\"form-check\"><input class=\"form-check-input\" type=\"radio\" name=\"gender\" id=\"Male_\" value=\"male\"><label for=\"Male_\" class=\"form-check-label\">Male</label></div><div class=\"form-check\"><input class=\"form-check-input\" type=\"radio\" name=\"gender\" id=\"Female_\" value=\"female\"><label for=\"Female_\" class=\"form-check-label\">Female</label></div><div class=\"form-check\"><input class=\"form-check-input\" type=\"radio\" name=\"gender\" id=\"Other_\" value=\"other\"><label for=\"Other_\" class=\"form-check-label\">Other</label></div><select class=\"form-select\" name=\"Country\"><option value=\"\">Select Country</option><option value=\"ind\">India</option><option value=\"ca\">Canada</option><option value=\"au\">Australia</option><option value=\"nz\">Newzealand</option></select><label>Student Image</label><input type=\"file\" class=\"form-control rounded-1\" name=\"image\" required=\"\"><label>Contact Number</label><input type=\"number\" class=\"form-control rounded-1\" name=\"contact\" placeholder=\"Enter input contact\" required=\"\"><label>Email address</label><input type=\"email\" class=\"form-control rounded-1\" name=\"email\" placeholder=\"Enter input email\" required=\"\"><label>Collage Email address</label><input type=\"email\" class=\"form-control rounded-1\" name=\"collage_email\" placeholder=\"Enter input collage_email\" required=\"\"><input type=\"submit\" name=\"submit\" class=\"btn btn-primary\" value=\"submit\"></form></div></div>', '<p>This is test student registration form which preview in frontend side as its preview seen in below if you haven\'t seen the preview please click \"Preview Form\" Button below for form preview</p>', NULL, '<p>test</p>', '<p>.<span style=\"background-color: #ffffff; color: #1f1f1f; font-family: \'dejavu sans mono\', monospace; font-size: 11px; white-space-collapse: preserve;\">displayGeneratedForm .card{<br /></span><span class=\"csspropertycolor\" style=\"box-sizing: inherit; color: red; font-family: Consolas, Menlo, \'courier new\', monospace; font-size: 15px; background-color: #ffffff;\">background-color<span class=\"csspropertyvaluecolor\" style=\"box-sizing: inherit; color: mediumblue;\"><span class=\"cssdelimitercolor\" style=\"box-sizing: inherit; color: black;\">:</span> grey<span class=\"cssdelimitercolor\" style=\"box-sizing: inherit; color: black;\">;</span></span></span><span style=\"background-color: #ffffff; color: #1f1f1f; font-family: \'dejavu sans mono\', monospace; font-size: 11px; white-space-collapse: preserve;\"><br />}</span></p>', '2023-12-20 09:24:23', '2023-12-22 06:13:10'),
(3, 'Test', 'sdgw', 'sdgsdf', '/afsd', 'save_entry', '<div class=\"card\"><div class=\"card-body\"><form action=\"/afsd\" method=\"post\" enctype=\"multipart/form-data\" id=\"dynamicForm\"><label>My Test</label><input type=\"text\" class=\"form-control\" name=\"test\" placeholder=\"Enter input My Test name\" required=\"\"><select class=\"form-select\" name=\"hello\"><option value=\"\">Select hello</option><option value=\"1111\">111</option><option value=\"2222\">22</option></select><label>New added</label><input type=\"text\" class=\"form-control\" name=\"newaddd\" placeholder=\"Enter input New added name\" required=\"\"><input type=\"submit\" name=\"submit\" class=\"btn btn-primary\" value=\"submit\"></form></div></div>', '<p>test content</p>', NULL, '<p>test js</p>', '<p>test css</p>', '2023-12-21 07:28:45', '2023-12-21 08:41:12');
...
(1, 'Homepage', '<p>Content center changed</p>', '2023-1215-14-43-28_It.jpeg', 'left', '[[\"Facebook-meta\",\"2023-1215-14-44-0_facebook-icon.png\",\"www.facebook-meta.com\"],[\"Whatsapp\",\"2023-1215-14-44-16_whatsapp-icon.png\",\"www.whatsapp.com\"],[\"Instagram\",\"2023-1215-14-44-37_instagram-icon.png\",\"www.instagram.com\"]]', '2023-12-15 07:19:14', '2023-12-15 09:15:05'),
...
(1, 'Test', 'Test', '2023-12-14', '2023-12-20', '2023-12-14 05:43:19', '2023-12-20 12:43:15'),
(2, 'Test', 'Test1', '2023-12-19', '2023-12-21', '2023-12-19 12:55:42', '2023-12-19 12:55:42');
...
--
-- Dumping data for table `slider_transactions`
--

INSERT INTO `slider_transactions` (`id`, `slider_id`, `slider_image`, `status`, `content`, `created_at`, `updated_at`) VALUES
(4, 2, '2023-1219-18-25-42_Screenshot from 2023-12-13 10-40-43.png', 'active', '<p>Test1</p>', '2023-12-19 12:55:42', '2023-12-19 12:55:42'),
(5, 2, NULL, 'inactive', '<p>Test2</p>', '2023-12-19 12:55:42', '2023-12-20 06:41:28'),
(6, 1, '2023-1220-18-25-12_Screenshot from 2023-12-07 13-37-29.png', 'active', '<p>Tesatast</p>', '2023-12-20 12:55:22', '2023-12-20 12:55:22');
...
(1, 'Admin', NULL, 'admin@volt.com', '$2y$10$nPkqFd64qoyLtv2ux6HZVefVoD9l2o1AGxGXesFpbsw7bN3W6iRbe', NULL, NULL, NULL, NULL, NULL, 'PwwoxJMvIZ2So3oV38rfbWuJ9oB9GeyzZjdBTGJgrGAGZ5iWnyJGWpywu3DT', NULL, NULL),
(2, 'Darshit Prajapati', NULL, 'darshit@mailinator.com', '$2y$10$irkv5RamQ6fjXJuLTZCLuuS0l4mj3x.i7Eu1KrD/eQcS4N..VEEZi', NULL, NULL, NULL, NULL, NULL, 'pRL8twQ42vOb6dqE8M2epHSk1w82v9CWkPmjUisWz45oC4L0W13sPT6lhzmh', '2023-10-19 02:00:58', '2023-10-19 02:00:58'),
(3, 'My_test123', NULL, 'mytest@mailinator.com', '$2y$10$mVyur.w/Da11fiOerRnGIuwB6lNepSg5Pg/NdSuTqVfjgRauxsf6e', NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-22 01:24:17', '2023-12-22 01:24:17');
