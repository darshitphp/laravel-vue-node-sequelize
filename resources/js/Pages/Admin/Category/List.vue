      ...
      <div class="card border-0 shadow mb-4">
        <div class="card-body">
          <div class="row justify-content-end">
            <div class="col-auto">
              <a href="/category/add" class="btn btn-gray-800 me-2 my-2">Add Category</a>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table class="table table-centered table-nowrap mb-0 rounded">
              ...
              <tr>
                ...
                <th class="border-0">Category Title</th>
                <th class="border-0">Category Slug</th>
...
export default {
  ...
  methods: {
    async fetchData() {
      try {
        const response = await axios.post(apiBaseUrl+'category/categoryData');
