...
<div class="sidebar-inner px-2 pt-3">
  ...
  <ul class="nav flex-column pt-3 pt-md-0">
    ...
    <li class="nav-item {{ Request::segment(1) == 'slider' ? 'active' : '' }}">
    ...
    <li class="nav-item {{ Request::segment(1) == 'form' ? 'active' : '' }}">
      <a href="/form" class="nav-link">
        ...
        <span class="sidebar-text">Form Management</span>
      </a>
    </li>
    <li class="nav-item {{ Request::segment(1) == 'header' ? 'active' : '' }}">
      <a href="/header" class="nav-link">
        ...
        <span class="sidebar-text">Header Management</span>
      </a>
    </li>
    <li class="nav-item">
        ...
        <ul class="flex-column nav">
          <li class="nav-item {{ Request::segment(1) == 'tag' ? 'active' : '' }}">
            <a href="/tag" class="nav-link">
              <span class="sidebar-text">Tag</span>
            </a>
          </li>
        </ul>
      </div>
